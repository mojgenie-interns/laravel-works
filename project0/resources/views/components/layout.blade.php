        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/superheroes" :active="request()->is('superheros')">Superheroes</x-nav-link>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      ...
      <div class="border-t border-white/10 pt-4 pb-3">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Arjun Nishadasan</div>
            <div class="text-sm font-medium text-gray-400">arjundaspalappilli@gmail.com</div>
          </div>
        </div>
