    ...
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <x-form-field>
          ...
          <div class="mt-2">
            <x-form-input id="first_name" name="first_name" placeholder="" required/>
        ...
        <x-form-field>
          ...
          <div class="mt-2">
            <x-form-input id="last_name" name="last_name" placeholder="" required/>
        ...
        <x-form-field>
          ...
          <div class="mt-2">
            <x-form-input type="password" id="password_confirmation" name="password_confirmation" placeholder="" required/>
